...
namespace Catch.Map
{
    public class Tile
    {
        private readonly ISet<IAgent> _mobs;
        ...
        public bool AddMob(IAgent mob) => _mobs.Add(mob);

        public bool ContainsMob(IAgent mob) => _mobs.Contains(mob);

        public bool RemoveMob(IAgent mob) => _mobs.Remove(mob);

        public int MobCount => _mobs.Count;

        public IEnumerable<IAgent> Mobs => _mobs;
